...
{
    using TEntity = Entities.Payment;
    using TContract = SEPayWithFun.Common.Contracts.IPayment;
    /// <summary>
    /// Generated by the generator.
    /// </summary>
    internal sealed partial class PaymentSet : EntitySet<TEntity>, Contracts.IPaymentSet
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentSet"/> class (created by the generator.)
        /// </summary>
        public PaymentSet(ProjectDbContext context, DbSet<TEntity> dbSet)
         : base(context, dbSet)
        {
            Constructing();
