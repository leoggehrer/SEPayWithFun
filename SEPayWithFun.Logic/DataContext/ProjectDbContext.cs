//@CodeCopy
using SEPayWithFun.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the SEPayWithFun application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=SEPayWithFun.db";
        #endregion fields
