//@CodeCopy
#if ACCOUNT_ON
using SEPayWithFun.Logic.Entities.Account;
using SEPayWithFun.Logic.Modules.Exceptions;
using SEPayWithFun.Logic.Modules.Security;
using System.Text;
using System.Text.RegularExpressions;

namespace SEPayWithFun.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using SEPayWithFun.Common.Modules.ThreadSafe;
