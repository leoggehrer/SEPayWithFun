...
namespace SEPayWithFun.ConApp
{
    partial class Program
    {
        ...
        /// </summary>
        private static string SaEmail => "LeoAdmin.SEPayWithFun@gmx.at";
        /// <summary>
        ...
        /// <summary>
        /// Gets the email address for the AppAdmin SEPayWithFun.
        /// </summary>
        private static string AaEmail => "AppAdmin.SEPayWithFun@gmx.at";
        /// <summary>
        ...
        /// </summary>
        private static string AppEmail => "AppUser.SEPayWithFun@gmx.at";
