...
namespace SEPayWithFun.MVVMApp.Models
{
    ...
    public partial class Payment : SEPayWithFun.Common.Contracts.IPayment
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                result = base.Equals(other) && IsEqualsWith(CardNumber, other.CardNumber)
        ...
        {
            return this.CalculateHashCode(base.GetHashCode(), CardNumber, ExecutionDate, TurnoverTime, DealerName, DealerLocation, Turnover, Note);
        }
    }
}
